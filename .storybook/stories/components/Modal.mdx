...
Você pode ver exemplos interativos do componente Modal nas seguintes páginas:

- [Exemplo Básico](/story/components-modal-examples--default)
- [Com Props Personalizadas](/story/components-modal-examples--with-custom-props)
- [Exemplo Personalizado](/story/components-modal-examples--custom-example)
## Importação
