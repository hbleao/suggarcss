...
Você pode ver exemplos interativos do componente Tooltip nas seguintes páginas:

- [Exemplo Básico](/story/components-tooltip-examples--default)
- [Com Props Personalizadas](/story/components-tooltip-examples--with-custom-props)
- [Exemplo Personalizado](/story/components-tooltip-examples--custom-example)
## Importação
