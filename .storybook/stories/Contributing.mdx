...
Obrigado por considerar contribuir com o ocean! Este documento fornece diretrizes para contribuir com o projeto, desde a configuração do ambiente de desenvolvimento até o processo de envio de pull requests.
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/hbleao/ocean.git
   cd ocean
   ```
...
- [Documentação do ocean](./README.md)
- [Padrões Técnicos](./technical-patterns.md)
- [Guia de Acessibilidade](./foundations/accessibility.md)

## Agradecimentos

Agradecemos a todos os contribuidores que ajudam a melhorar o ocean! Seu tempo e esforço são muito apreciados.
