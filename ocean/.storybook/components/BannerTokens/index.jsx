export const BannerTokens = (props) => (
	<div
		className="banner"
		style={{
	...
	>
		...
		<div
			style={{
				...
				height: "100px",
				background:
					"url(\"data:image/svg+xml,%3Csvg width='200' height='100' viewBox='0 0 200 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 50 C 40 30, 60 70, 100 50 C 140 30, 160 70, 200 50 L 200 100 L 0 100 Z' fill='rgba(255,255,255,0.1)' /%3E%3C/svg%3E\")",
