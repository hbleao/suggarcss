...
describe('Typography', () => {
  ...
  it('deve renderizar com variante personalizada', () => {
    render(<Typography variant="title3" data-testid="typography">Título</Typography>);
  ...
  it('deve renderizar com tag HTML personalizada', () => {
    render(<Typography as="h2" data-testid="typography">Subtítulo</Typography>);
  ...
  it('deve renderizar com cor personalizada', () => {
    render(<Typography color="primary-500" data-testid="typography">Texto colorido</Typography>);
  ...
  it('deve renderizar com peso de fonte personalizado', () => {
    render(<Typography weight="bold" data-testid="typography">Texto em negrito</Typography>);
  ...
  it('deve renderizar com estilo de fonte personalizado', () => {
    render(<Typography fontStyle="italic" data-testid="typography">Texto em itálico</Typography>);
  ...
  it('deve aplicar classes CSS adicionais', () => {
    render(<Typography className="custom-class" data-testid="typography">Texto com classe</Typography>);
  ...
  it('deve renderizar como parágrafo', () => {
    render(<Typography as="p" variant="body1" data-testid="typography">Parágrafo de texto</Typography>);
  ...
  it('deve renderizar como span', () => {
    render(<Typography as="span" variant="caption" data-testid="typography">Texto pequeno</Typography>);
  ...
  it('deve renderizar como label', () => {
    render(<Typography as="label" variant="label" data-testid="typography">Rótulo</Typography>);
