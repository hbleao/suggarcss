...
describe("<Dialog />", () => {
	...
	it("deve renderizar quando isOpen é true", () => {
		...
		// Verificar se o clsx foi chamado com os argumentos corretos para o overlay
		...
		// Verificar se o clsx foi chamado com os argumentos corretos para o box
		expect(mockClsx).toHaveBeenCalledWith(
			"dialog__box",
			"--small"
		);
	...
	it("deve renderizar o ícone corretamente", () => {
		...
		// Verificar se o clsx foi chamado corretamente
		expect(mockClsx).toHaveBeenCalledWith(
			"dialog",
			"dialog__overlay",
			{
		...
		// Verificar se o ícone X do Lucide React está presente
	...
	it("deve aplicar a variante de rodapé corretamente", () => {
		...
		// Verificar se o clsx foi chamado com os argumentos corretos para o footer
	...
	it("deve aplicar classes CSS adicionais", () => {
		...
		// Verificar se o clsx foi chamado com os argumentos corretos incluindo a classe adicional
		expect(mockClsx).toHaveBeenCalledWith(
			"dialog",
			"dialog__overlay",
			{
